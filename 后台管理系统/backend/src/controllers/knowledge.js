...
export async function getKnowledgeFiles(req, res) {
  try {
...
// 异步处理知识库文件
async function processKnowledgeFile(fileId, filePath) {
  try {
...
export async function deleteKnowledgeFile(req, res) {
  try {
    const { id } = req.params
...
export async function rebuildKnowledgeIndex(req, res) {
  try {
...
// 创建分类
export async function createKnowledgeCategory(req, res) {
  try {
...
// 更新分类
export async function updateKnowledgeCategory(req, res) {
  try {
    const { id } = req.params
...
// 删除分类
export async function deleteKnowledgeCategory(req, res) {
  try {
    const { id } = req.params
    const categoryId = parseInt(id)
